    ...
    try:
        ...
        if event == 'run_taxonomy_table_check':
            ...
            if (taxonomy_table_path == ''):
                ...
                from _app.check_taxononomy_table_format import check_taxononomy_table_format
                if sorting_method_fh == True:
                    sheet_name = "First hit"
                elif sorting_method_jamp == True:
                    sheet_name = "JAMP hit"
        ...
        if event == 'run_read_table_check':
            ...
            if (Read_table_path == ''):
                ...
                from _app.check_read_table_format import check_read_table_format_TTT
        ...
        if event == "run_convert_to_pa":
            ...
            if taxon_table_processing_1_table == '':
                ...
                from _app.convert_to_presence_absence import covert_to_presence_absence
        ...
        if event == 'run_rarefaction_curve_OTUs':
            if statistics_2_taxon_table_path == '':
                ...
                if error_bar_style_b == True:
                    error_bar_style = "b"
                from _app.rarefaction_curve import rarefaction_curve_OTUs
        ...
        if event == 'run_rarefaction_curve_species':
            if statistics_2_taxon_table_path == '':
                ...
                if error_bar_style_b == True:
                    error_bar_style = "b"
                from _app.rarefaction_curve import rarefaction_curve_species
                        ...
                        while True:
                            ...
                            if event2 == 'Calculate':
                                    for input_value, test in values2.items():
                                            if test == True:
                                                    meta_data_to_test = input_value
                                                    from _app.CCA_analysis import CCA_analysis
                            ...
                            while True:
                                ...
                                if event2 == 'Calculate':
                                        for meta_data_to_test, test in values2.items():
                                            if test == True:
                                                from _app.alpha_diversity import alpha_diversity
                    ...
                    if meta_data_to_test == False:
                            ...
                            while True:
                                ...
                                if event2 == 'Calculate':
                                        for meta_data_to_test, test in values2.items():
                                            if test == True:
                                                from _app.beta_diversity import beta_diversity
