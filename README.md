...
* Initially, the taxonomy table and read table must be cinverted to a TaXon table, the standard input format for TTT (see [manual](_data/TaXonTableTools_manual.docx) for definitions and requirements).

* Check out the [tutorial](_data/TaXonTableTools_tutorial.pptx) to get an impression of the TTT workflow.
