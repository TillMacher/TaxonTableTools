...
taxon_tools_version = "Version 1.0 (r28.04.2020)"
...
"Taxonomic_richness_plots", "PCoA_plots", "Taxonomic_resolution_plots", "Meta_data_table", "Site_occupancy_plots", "Read_proportions_plots", "Basic_stats",
"Krona_charts", "Perlodes", "Alpha_diversity"]
...
data_conversion = [
					...
					[sg.Text('Taxonomy table:', size=(20, 1)), sg.Input(), sg.FileBrowse(key = 'taxonomy_table_path'), sg.Button("Check table", key = 'run_raxon_table_check', button_color=('black', 'white'))],
                    [sg.Text('Sorting method:', size=(20, 1)),  sg.Radio('First hit', "sorting_method", default=True, key='sorting_method_fh'), sg.Radio('JAMP', "sorting_method", key='sorting_method_jamp'), sg.Radio('BOLDigger', "sorting_method", key='sorting_method_boldigger')],
					...
					[sg.Button("Convert", key = 'run_taxon_converter')],
					[sg.Text('_'*105)],
...
analysis_1_layout = [
					...
					[sg.Text("Calculate basic statistics", size=(25,1)), sg.Button("Run", key = 'run_basic_stats')],
					[sg.Text('',size=(1,1))],
					[sg.Text('Taxonomic resolution',size=(40,2), font=('Arial', 11, "bold"))],
					[sg.Text("Taxonomic resolution plot", size=(25,1)), sg.Button("Run", key = 'run_taxonomic_resolution'), sg.Text("", size=(1,1)), sg.Frame(layout=[[sg.Text("Plot size (w,h):"), sg.Input("20", size=(3,1), key="x_tax_res"),
                    sg.Input("10", size=(3,1), key="y_tax_res"), sg.Text("", size=(1,1)), sg.Text("Font size:"), sg.Input("10", size=(3,1), key="font_tax_res"), sg.Radio('scatter', "tres_plot_type", key='tres_scatter', default=True), sg.Radio('bar', "tres_plot_type", key='tres_bar')]], title="Options")],
					[sg.Text('',size=(1,1))],
					[sg.Text('Taxonomic richness',size=(40,2), font=('Arial', 11, "bold"))],
					[sg.Text("Taxonomic richness plot", size=(25,1)), sg.Button("Run", key = 'run_taxonomic_richness'), sg.Text("", size=(1,1)), sg.Frame(layout=[[sg.Text("Plot size (w,h):"), sg.Input("20", size=(3,1), key="x_tax_rich"),
                    sg.Input("10", size=(3,1), key="y_tax_rich"), sg.Text("", size=(1,1)), sg.Text("Font size:"), sg.Input("10", size=(3,1), key="font_tax_rich"), sg.Radio('scatter', "trich_plot_type", key='trich_scatter', default=True), sg.Radio('bar', "trich_plot_type", key='trich_bar')]], title="Options")],
					[sg.Text('',size=(1,1))],
					]
...
analysis_2_layout =  [
					...
					[sg.Text("Calculate rarefaction curve with"), sg.Input('1000', size=(6,1), key='repetitions'), sg.Text('repetitions'), sg.Button("Run", key = 'run_rarefaction_curve'), sg.Text("", size=(1,1)),
...
available_alpha_metrics = ["berger_parker_d", "brillouin_d", "chao1", "dominance", "fisher_alpha", "gini_index",
"heip_e", "mcintosh_d", "mcintosh_e", "pielou_e", "shannon", "simpson", "simpson_e", "observed_otus"]
available_alpha_metrics_list = list(slices([sg.Radio(name, "alpha_diversity_estimate", key=name, default=True) for name in sorted(available_alpha_metrics)], 5))
...
analysis_4_layout =  [
					...
					[sg.Text("Calculate PCoA", size=(23,1)), sg.Button("Run", key = 'run_PCoA_analysis'), sg.Text("", size=(2,1)),
                    sg.Frame(layout=[[sg.Text("Principle coordinates analysis (Bray-Curtis and Jaccard)")]], title="Information")],
					[sg.Text('',size=(1,1))],
					[sg.Text('Alpha diversity',size=(40,2), font=('Arial', 11, "bold"))],
                    [sg.Frame(layout = available_alpha_metrics_list, title = 'Specific alpha diversity estimates')],
					[sg.Text('',size=(1,1))],
                    [sg.Frame(layout=[[sg.Text("Plot size (w,h):"), sg.Input("10", size=(3,1), key="x_alpha_div_props"),
                    sg.Input("10", size=(3,1), key="y_alpha_div_props"), sg.Text("", size=(1,1)), sg.Text("Font size:"), sg.Input("8", size=(3,1), key="font_alpha_div"),
                    sg.Text("", size=(1,1)), sg.Text("Scatter size:"), sg.Input("40", size=(3,1), key="size_alpha_div")]], title="Options")],
					[sg.Text('',size=(1,1))],
					[sg.Text("Calculate Alpha diversity", size=(23,1)), sg.Button("Run", key = 'run_specific_alpha_div')],
                    [sg.Text('',size=(1,1))],
					]
...
while True:
    try:
        ...
        x_alpha_div_props = values["x_alpha_div_props"]
        x_alpha_div_props = values["x_alpha_div_props"]
        y_alpha_div_props = values["y_alpha_div_props"]
        font_alpha_div = values["font_alpha_div"]
        size_alpha_div = values["size_alpha_div"]
        tres_scatter = values["tres_scatter"]
        trich_scatter = values["trich_scatter"]
        tres_bar = values["tres_bar"]
        trich_bar = values['trich_bar']
        ...
        if event == 'run_raxon_table_check':
            ...
            if (taxonomy_table_path == ''):
                ...
                from _app.check_taxon_table_format import check_taxon_table_format
                if sorting_method_fh == True:
                    sheet_name = "First hit"
                elif sorting_method_jamp == True:
                    sheet_name = "JAMP results"
                    ...
                    sheet_name = "BOLDigger results"
                check_taxon_table_format(taxonomy_table_path, sheet_name)
        ...
        if event == 'run_read_table_check':
            ...
            if (Read_table_path == ''):
                ...
                from _app.check_read_table_format import check_read_table_format
        ...
        if event == "run_taxon_table_per_sample":
            ...
            if taxon_table_processing_1_table == '':
                ...
                from _app.create_taxon_table_per_sample import create_taxon_table_per_sample
        ...
        if event == 'run_pie_chart':
            ...
            if statistics_2_taxon_table_path == '':
                ...
                from _app.pie_charts import pie_charts
        ...
        if event == 'run_venn2_diagram':
            ...
            if (statistics_2_taxon_table_path == '' or venn_taxon_table_2_path == ''):
                ...
                from _app.venn_diagram import venn_diagram
        ...
        if event == 'run_rarefaction_curve':
            if statistics_2_taxon_table_path == '':
                ...
                if error_bar_style_b == True:
                    error_bar_style = "b"
                from _app.rarefaction_curve import rarefaction_curve
                rarefaction_curve(statistics_2_taxon_table_path, int(repetitions), error_bar_style, path_to_outdirs)
        ...
        if event == 'run_create_taxon_list':
            ...
            if taxon_list_taxon_table_path == '':
                ...
                from _app.create_taxon_list import create_taxon_list
        ...
        if event == 'run_taxon_filtering' and not win2_active:
            ...
            if taxon_table_processing_2_table == '':
                ...
                from _app.taxon_table_filtering import create_taxa_mask
                ...
                while True:
                    ...
                    if event2 == 'Filter':
                        ...
                        from _app.taxon_table_filtering import taxon_table_filter
        ...
        if event == 'run_sample_filtering' and not win2_active:
            if taxon_table_processing_2_table == '':
                ...
                from _app.taxon_table_filtering import create_sample_mask
                ...
                while True:
                    ...
                    if event2 == 'Filter':
                        ...
                        from _app.taxon_table_filtering import exclude_samples
        ...
        if event == 'run_combine_replicates':
            ...
            if taxon_table_processing_1_table == '':
                ...
                from _app.combine_replicates import combine_replicates
        ...
        if event == 'run_taxonomic_richness':
            if statistics_1_taxon_table_path == '':
                ...
                if trich_scatter == True:
                    figure_type = "scatter"
                if trich_bar == True:
                    figure_type = "bar"
                from _app.calculate_taxonomic_richness import calculate_taxonomic_richness
                calculate_taxonomic_richness(statistics_1_taxon_table_path, path_to_outdirs, x_tax_rich, y_tax_rich, font_tax_rich, figure_type)
        ...
        if event == 'run_taxonomic_resolution':
            if statistics_1_taxon_table_path == '':
                ...
                if tres_scatter == True:
                    figure_type = "scatter"
                if tres_bar == True:
                    figure_type = "bar"
                from _app.calculate_taxonomic_resolution import calculate_taxonomic_resolution
                calculate_taxonomic_resolution(statistics_1_taxon_table_path, path_to_outdirs, x_tax_res, y_tax_res, font_tax_res, figure_type)
        ...
        if event == 'run_create_meta_data_table':
            if taxon_table_processing_2_table == '':
                ...
                from _app.create_metadata_table import create_metadata_table
        ...
        if event == 'run_site_occupancy':
            if statistics_3_taxon_table_path == '':
                ...
                from _app.site_occupancy import get_available_meta_data
                ...
                if meta_data_to_test == False:
                             ...
                             while True:
                                          ...
                                          if event2 == 'Calculate':
                                                       ...
                                                       from _app.site_occupancy import site_occupancy
        ...
        if event == 'run_read_proportions':
            if statistics_3_taxon_table_path == '':
                ...
                from _app.read_proportions import read_proportions
        ...
        if event == 'run_basic_stats':
            if statistics_1_taxon_table_path == '':
                ...
                from _app.basic_stats import basic_stats
        ...
        if event == 'run_create_krona_chart':
            if statistics_3_taxon_table_path == '':
                ...
                from _app.create_krona_chart import create_krona_chart
                                ...
                                if event2 == 'Calculate':
                                        for input_value, test in values2.items():
                                                if test == True:
                                                        ...
                                                        meta_data_to_test = input_value
                                                        from _app.PCoA_analysis import PCoA_analysis
        ...
        if event == 'run_replicate_consistency_filter':
            if taxon_table_processing_1_table == '':
                ...
                replicate_suffix_list = replicate_suffix_entry.replace(" ", "").split(",")
                from _app.replicate_consistency_filter import replicate_consistency_filter
        ...
        if event == 'run_specific_alpha_div':
                ...
                if statistics_4_taxon_table_path == '':
                    ...
                    if meta_data_to_test == False:
                            ...
                            layout2 = [[sg.Text("Basic alpha diversity", size=(20,1))],
                            [sg.Frame(layout = meta_data_to_test_list, title = 'Check taxa to exlude')],
                            [sg.Button('Calculate')],
                            [sg.Button('Back')]] # test = True
                                ...
                                if event2 == 'Calculate':
                                        for input_value, test in values2.items():
                                                if test == True:
                                                        ...
                                                        # check which alpha div estimate was chosen
                                                        for metric in available_alpha_metrics:
                                                            if values[metric] == True:
                                                                alpha_diversity_estimate = metric

                                                        # start the estimate function
                                                        meta_data_to_test = input_value
                                                        from _app.specific_biodiversity_estimates import specific_biodiversity_estimates
                                                        specific_biodiversity_estimates(statistics_4_taxon_table_path, meta_data_to_test, alpha_diversity_estimate, x_alpha_div_props, y_alpha_div_props, font_alpha_div, size_alpha_div, path_to_outdirs)
                                                        win2.Close()
                                                        win2_active = False
                                                        window.UnHide()
                                                        break
